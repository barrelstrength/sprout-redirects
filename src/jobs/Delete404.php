...
namespace barrelstrength\sproutredirects\jobs;
...
class Delete404 extends BaseJob
{
    ...
    {
        return Craft::t('sprout-redirects', 'Deleting oldest 404 redirects');
    }
    ...
    public function execute($queue)
    {
        ...
        foreach ($redirects as $key => $redirect) {
            ...
            if (!$response) {
                SproutRedirects::error('SproutRedirects has failed to delete the 404 redirect Id:'.$redirect['id']);
            }
        }
