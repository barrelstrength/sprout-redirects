...
use barrelstrength\sproutredirects\validators\StatusValidator;
    ...
    public function performAction(ElementQueryInterface $query): bool
    {
        ...
        foreach ($elementIds as $key => $redirectId) {
            ...
            if ((int)$redirect->method === RedirectMethods::PageNotFound) {
                $this->setMessage(Craft::t('sprout-redirects', 'Unable to enable a 404. Update redirect method.'));
                return false;
            }
        }
        ...
        $this->setMessage(Craft::t('sprout-redirects', 'Statuses updated.'));
